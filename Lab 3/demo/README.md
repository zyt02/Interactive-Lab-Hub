...
| ------------------ | -------------------------- | ------------------------------------------- |
| Speech Recognition | Vosk                       | Convert user voice to text                  |
| Language Model     | Ollama (Flask API)         | Process text input and generate a response  |
| TTS                | eSpeak / Pico TTS          | Speak Ollama’s response                     |
| Audio I/O          | `arecord` / ALSA / PyAudio | Capture microphone input +play audio output |

Below is what the users said and Ollama's Response : 
| User  | Input                            | Ollama Response                                             |
| ----- | -------------------------------- | ----------------------------------------------------------- |
| Carol | “What’s 7 times 8?”              | “7 times 8 is 56.”                                          | 
| Dave  | “What day is after Friday ?”     | “It is Saturday.”                                           | 

Some findings:
- Sometimes the TTS reponse seems to be cutted off.
- The model works better with questions with a very definite answers.

For the python file, please refer to : ``
